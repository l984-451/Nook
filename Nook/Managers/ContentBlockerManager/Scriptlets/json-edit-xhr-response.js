// json-edit-xhr-response.js — Edit XHR JSON responses (restricted values, non-trusted).
// Usage: json-edit-xhr-response(editExpression, propsToMatch, [urlPattern])
(function() {
    'use strict';
    ...
    XMLHttpRequest.prototype.open = function(method, url) { this._nookJEUrl = String(url); return origOpen.apply(this, arguments); };
    XMLHttpRequest.prototype.send = function() {
        if (urlRe && !urlRe.test(this._nookJEUrl || '')) return origSend.apply(this, arguments);
