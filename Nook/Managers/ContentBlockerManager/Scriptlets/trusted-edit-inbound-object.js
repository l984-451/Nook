// trusted-edit-inbound-object.js — Edit function arguments before execution.
// Usage: trusted-edit-inbound-object(funcPath, propPath, value)
(function() {
    'use strict';
    ...
    target[methodName] = function() {
        ...
        for (let i = 0; i < modifiedArgs.length; i++) {
            if (typeof modifiedArgs[i] === 'object' && modifiedArgs[i] !== null) {
                setNestedProp(modifiedArgs[i], propPath, value);
            }
        }
