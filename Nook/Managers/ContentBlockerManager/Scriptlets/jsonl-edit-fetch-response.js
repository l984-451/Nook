// jsonl-edit-fetch-response.js — Edit fetch JSONL responses (non-trusted).
// Usage: jsonl-edit-fetch-response(editExpression, propsToMatch, [urlPattern])
(function() {
    'use strict';
            ...
            return Reflect.apply(target, thisArg, argumentsList).then(response => {
                ...
                return clone.text().then(text => {
                    try {
                        ...
                        if (modified) { const newHeaders = new Headers(response.headers); newHeaders.delete('content-length');
