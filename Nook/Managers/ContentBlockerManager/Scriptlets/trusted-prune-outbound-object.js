// trusted-prune-outbound-object.js — Prune keys from function return values.
// Usage: trusted-prune-outbound-object(funcPath, keys)
(function() {
    'use strict';
    ...
    target[methodName] = function() {
        ...
        if (typeof result === 'object' && result !== null) pruneObject(result);
        return result;
    };
})();
